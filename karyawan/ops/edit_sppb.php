...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Cari Data sppb -->
          <?php
          $sql = $koneksi->query("SELECT * FROM sppb INNER JOIN pelanggan ON sppb.id_pelanggan=pelanggan.id_pelanggan WHERE no_sppb='$id'") or die(mysqli_error($koneksi));
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form method="post">
                <div class="mb-3">
                  <label for="exampleInputno1" class="form-label">Nomor SPPB</label>
                  <input type="text" class="form-control" id="exampleInputno1" aria-describedby="noHelp" name="no_sppb" value="<?= $hasil['no_sppb']; ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="exampleInputbiaya1" name="biaya" value="<?= $hasil['biaya_sppb']; ?>">
                </div>
    ...
    if (isset($_POST['simpan'])) {
      $update = $koneksi->query("UPDATE sppb SET biaya_sppb='$_POST[biaya]' WHERE no_sppb='$id'") or die(mysqli_error($koneksi));
      echo "
        <script>
