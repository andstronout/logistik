  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
                  ...
                  if ($sql != null) { ?>
                    ...
                    <div class="after cek">
                      ...
                      <div class="mb-3 ">
                        ...
                        <input type="text" class="form-control" id="exampleInputpengajuan1" aria-describedby="pengajuanHelp" name="no_pengajuan" placeholder="Masukan nomor pengajuan" required>
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputbiaya1" class="form-label">Biaya PIB</label>
                        <input type="text" class="form-control" id="exampleInputbiaya1" name="biaya" placeholder="Masukan Biaya" required>
                      </div>
      ...
      if (isset($_POST['simpan'])) {
        ...
        $insert = $koneksi->query("INSERT INTO pib (id_joborder,no_pengajuan,id_pelanggan,id_karyawan,tgl_pib,biaya_pib) VALUES ('$_POST[id_joborder]','$_POST[no_pengajuan]','$_POST[id_pelanggan]','$_SESSION[id_karyawan]','$tanggalpib','$_POST[biaya]')") or die(mysqli_error($koneksi));
        // echo "
        //       <script>
