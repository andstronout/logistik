...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Cari Data PIB -->
          <?php
          $sql = $koneksi->query("SELECT * FROM pib INNER JOIN job_order ON job_order.id_joborder=pib.id_joborder INNER JOIN pelanggan ON pib.id_pelanggan=pelanggan.id_pelanggan WHERE no_pib='$id'") or die(mysqli_error($koneksi));
            ...
            <div class="card-body">
              <form method="post">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="exampleInputno1" aria-describedby="noHelp" name="no_pib" value="<?= $hasil['no_pib']; ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 ">
                  ...
                  <input type="text" class="form-control" id="exampleInputpengajuan1" aria-describedby="pengajuanHelp" name="no_pengajuan" value="<?= $hasil['no_pengajuan']; ?>">
                </div>
                <div class="mb-3">
                  <label for="exampleInputbiaya1" class="form-label">Biaya PIB</label>
                  <input type="text" class="form-control" id="exampleInputbiaya1" name="biaya" value="<?= $hasil['biaya_pib']; ?>">
                </div>
    ...
    if (isset($_POST['simpan'])) {
      $update = $koneksi->query("UPDATE pib SET no_pengajuan='$_POST[no_pengajuan]',biaya_pib='$_POST[biaya]' WHERE no_pib='$id'") or die(mysqli_error($koneksi));
      echo "
        <script>
